...
public class CountCommitsPerMonthPlugin implements AnalyzerPlugin{
    ...
    public static class Result implements AnalyzerPlugin.Result {
        ...
        public String getResultAsHtmlDiv() {
            ...
            html.append(" <div id=\"showDiv4\" style=\"display:none;\"><embed src=\""+ pwd + "/.graphs/CommitsPerMonth.pdf\"width=\"45%\"height=\"500px\"></embed><embed src=\""+ pwd + "/.graphs/CommitsPerMonthPercent.pdf\"width=\"45%\"height=\"500px\"></embed><table><tbody><thead><tr><th>Commits count</th><th>Month</th></thead>");
