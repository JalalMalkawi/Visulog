...
public class CountCommitsPerDayPlugin implements AnalyzerPlugin{
    ...
    public static class Result implements AnalyzerPlugin.Result {
        ...
        public String getResultAsHtmlDiv() {
            ...
            html.append("<div id=\"showDiv1\" style=\"display:none;\" ><img src=\""+ pwd + "/.visulogRTempFiles/CommitsPerDate.pdf\"> <table><tbody><thead><tr><th>Commits count </th><th>Day</th></thead>");
            ...
            while (list.hasNext()){
                ...
                if(commitsPerDay.size()-commitsPerDay.indexOf(item)== max+1){
                    html.append("</tbody>" + "</table>" +"<p onclick=\"toggle('showDiv1SousPartie')\"> suite :<p>" +"<div id=\"showDiv1SousPartie\" style=\"display:none;\">" + "<table>" +" <tbody>");
                }
                if(item!=null) {
                    html.append("<tr>");
